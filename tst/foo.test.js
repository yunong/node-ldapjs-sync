...
//   remoteLdap = exec('node ./tst/remoteInmemLdap.js', function(error, stdout, stderr) {
//     if (error) {
//       console.log(error);
//       t.fail(error);
//     }
//     console.log('remoteLdap started');
//   });
...
test('push delete changelog dn doesn\'t match', function(t) {
  ...
  entryQueue.on('popped', function() {
    replContext.checkpoint.getCheckpoint(replContext.url,
      ...
      t.equal(checkpoint, changelog.object.changenumber);
      t.end();
    });
  });
