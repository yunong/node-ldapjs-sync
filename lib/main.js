...
function processConfig() {
  ...
  if (CONFIG.local_url && CONFIG.remote_url && CONFIG.checkpoint_dn) {
    ...
    console.error('missing configuration arguments, exiting');
    process.exit(1);
  }
}
...
var replContext = new Replicator(REPL_CONFIG);
