...
Checkpoint.prototype.init = function init(options) {
  ...
  this.pool = poolModule.Pool({
    ...
    max: options.poolCfg.max,
    idleTimeoutMillis: options.poolCfg.idleTimeoutMillis,
    reapIntervalMillis: options.poolCfg.reapIntervalMillis,
    log: options.poolCfg.log
  });
